...
\end{itemize}
%SOURCE DPI : https://www.youtube.com/watch?v=QHHYpwtwd5I

%SOURCE BOOK FIREWALL: zelfde als source DNS (chapter 8.8)
%SOURCE PFSENSE: https://www.pfsense.org/
% SOURCE PFSENSE extra: http://www.rom.lv/pfsense/pfSense_%20The%20Definitive%20Guide%20Version%202.1.pdf (NIET DE LINK ZELF GEBRUIKEN? TIS EEN BOEK)


% SOURCE DNS: Computer Networking A top-down approach fifth edition, James F. Kurose, Keith W. Ross
% SOURCE VIEWS: http://www.zytrax.com/books/dns/ch7/view.html
% SOURCE VIEW CODE: https://serverfault.com/questions/910207/whitelisting-blacklisting-using-bind
%SOURCE DNS COUNCIL: https://www.afnic.fr/medias/documents/conseilscientifique/SC-consequences-of-DNS-based-Internet-filtering.pdf
